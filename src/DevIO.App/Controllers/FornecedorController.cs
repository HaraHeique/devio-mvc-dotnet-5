...
namespace DevIO.App.Controllers
{
    ...
    public class FornecedorController : BaseController
    {
        ...
        public async Task<IActionResult> Edit(Guid id, FornecedorViewModel fornecedorViewModel)
        {
            ...
            if (!ModelState.IsValid) return View(await ObterFornecedorProdutosEndereco(id));
        ...
        public async Task<IActionResult> GetAtualizarEndereco(Guid id)
        {
            var fornecedorVM = await ObterFornecedorEndereco(id);

            if (fornecedorVM == null) return NotFound();

            return PartialView("_AtualizarEndereco", new FornecedorViewModel { Endereco = fornecedorVM.Endereco });
        }
